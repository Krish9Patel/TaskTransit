...
async function fetchTasks() {
  ...
  tasks = await response.json();
  tasks.forEach(task => {
      task.start = new Date(task.start); // Convert string to Date
...
// Task info modal to have description
...
// Edit form modal to edit it if needed
function showEditForm(task) {
  currentTaskIndex = task._id; // MongoDB _id used
